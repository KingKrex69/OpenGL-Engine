...
class Texture3D:
    ...
    def loadTexture(self, fname):
        ...
        for i in range(6):
            ...
            glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, GL_RGB, self.width, self.height, 0, GL_RGB, GL_UNSIGNED_BYTE, images[i])
            glEnable(GL_TEXTURE_CUBE_MAP) #glGenerateMipmap(GL_TEXTURE_CUBE_MAP)
