...
class Shader:
    ...
    def updateUniforms(self, view, proj, model, mat):
        ...
        self.setUniformFloat("spectacularIntensity", mat.specularIntensity)
    ...
    def compile_shader(self, fname):
        return OpenGL.GL.shaders.compileProgram(OpenGL.GL.shaders.compileShader(self.load_shader(fname + ".vs"), GL_VERTEX_SHADER), OpenGL.GL.shaders.compileShader(self.load_shader(fname + ".fs"), GL_FRAGMENT_SHADER))
